 ...
 * */
/*计划发布弹框*/
import { ShareModalForm } from "./component/ShareModalForm";
...
import { useDel, useInit } from "api/work-plan/plan";
...
export const PlanWork = () => {
  ...
  const menuList = menu
    ...
    .childMenu.find(
      (item: { [item: string]: unknown }) => item.name === "作业计划"
    ).childMenu;
                  ...
                  <Dropdown
                    overlay={
                      <Menu>
                        ...
                        {item.status === 2 && isButton(menuList, "删除") ? (
                          <Menu.Item disabled key={"delete"}>
                            删除
                          </Menu.Item>
                        ) : (
