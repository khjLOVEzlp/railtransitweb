...
import { WarehouseModal } from './dialog/modal'
const { Option } = Select
export const Warehouse = () => {
  ...
  const getUserList = () => {
    client(`warehouse/list?${qs.stringify(pagination)}`, { method: "POST" }).then(res => {
      setData(res.data)
  ...
  return (
    <div>
      ...
      <Main>
        ...
        {isShow ? <WarehouseModal formData={formData} formType={formType} isShow={isShow} setIsShow={setIsShow} getUserList={getUserList} /> : ''}
      </Main>
    </div>
  )
}
