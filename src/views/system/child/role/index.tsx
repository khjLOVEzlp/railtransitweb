...
import { RoleModal } from "./dialog/modal";
...
export const Role = () => {
  ...
  const getRoleList = () => {
    client(`role/list?${qs.stringify(pagination)}`, { method: "POST" }).then(res => {
      setData(res.data)
  ...
  return (
    <div>
      ...
      <Main>
        ...
        {isShow ? <RoleModal formData={formData} formType={formType} isShow={isShow} setIsShow={setIsShow} getRoleList={getRoleList} /> : ''}
      </Main>
    </div>
  )
}
